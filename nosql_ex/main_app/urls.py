...
# For example when using 'python manage.py runserver' -> http://127.0.0.1:8000/main_app/api/meteorite_landings/
urlpatterns = [
    path('',views.index,name='index'),
    path('api/meteorite_landings/', views.MeteoriteLandingsApiView.as_view())
    ]